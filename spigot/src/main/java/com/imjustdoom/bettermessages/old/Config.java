package com.imjustdoom.bettermessages.old.config;
...
import com.imjustdoom.bettermessages.old.message.MessageBuilder;
...
public class Config {
    ...
    public static final Map<Class<? extends MessageImpl>, List<MessageImpl>> MESSAGES = new HashMap<>();
    ...
    public static void init() {
        ...
        for (String msg : getConfig().getConfigurationSection("messages").getKeys(false)) {
            ...
            for (String type : getConfig().getStringList("messages." + msg + ".activation")) {
                ...
                MessageImpl message = new MessageBuilder()
                        .setParent(msg)
                        .setMessage(messages)
