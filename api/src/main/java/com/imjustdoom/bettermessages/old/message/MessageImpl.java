...
import com.imjustdoom.bettermessages.old.message.type.ActionBarMessageType;
import com.imjustdoom.bettermessages.old.message.type.ChatMessageType;
import com.imjustdoom.bettermessages.old.message.type.TitleMessageType;
...
public class MessageImpl implements Message {
    ...
    public MessageImpl(String parent, List<String> message, List<String> commands, List<Integer> count, boolean permission, boolean enabled, String audience, String storageType, String dontRunIf, long delay, int priority, String messageType) {
        this(parent, message, commands, count, permission, enabled, audience, storageType, dontRunIf, delay, priority, messageType, null);
    }

    public MessageImpl(String parent, List<String> message, List<String> commands, List<Integer> count, boolean permission, boolean enabled, String audience, String storageType, String dontRunIf, long delay, int priority, String messageType, String extraInfo) {
        this.parent = parent;
    ...
    public boolean canRun(BMPlayer player, Event event) {
    ...
    public boolean otherChecks(BMPlayer player, Event event) {
        return true;
    }
    ...
    public void sendMessage(BMPlayer player) {
